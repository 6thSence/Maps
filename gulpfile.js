...
var
	paths = {
		...
		browserSync : {
			baseDirDist : './dist',
			baseDir : './',
			watchPaths : ['markups/**/*.jade', 'styles/**/*.scss', 'js/*.js']
		}
	}
...
gulp.task('watch', function(){
	gulp.watch(paths.jade.location, ['jade'], browserSync.reload);
	gulp.watch(paths.scss.location, ['compass'],browserSync.reload);
	gulp.watch(paths.js.location, ['scripts'],browserSync.reload);
	gulp.watch(paths.js.plugins, ['plugins'], browserSync.reload);
	gulp.watch('bower.json',['jade'],browserSync.reload);
